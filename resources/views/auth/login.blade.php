          ...
          <div class="form-content">
            <div class="form-items">
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-button"><button id="submit" type="submit" class="ibtn">Login</button> <a href="forget17.html">Forget password?</a></div>
              </form>
              ...
              <div class="page-links">
                <a href="register17.php">Register new account</a>
              </div>
            </div>
          </div>
        </div>
